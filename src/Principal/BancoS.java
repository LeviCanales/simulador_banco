...
public class BancoS extends Canvas implements KeyListener{
	...
	public static final int ANCHO_VENTANA = 1100/*DEFINA SUS PROPIAS DIMENSIONES*/;
	public static final int ALTO_VENTANA = 872/*DEFINA SUS PROPIAS DIMENSIONES*/;
	...
	public BancoS(){
		...
		ventana.setTitle("Banco"); //Definir el titulo de la ventana
	...
	public void cargarImagenes(){
		...
		try {
			...
			movCliente.put("1st", ImageIO.read(getClass().getResource("/recursos/capa_07.png")));
			movCliente.put("2nd", ImageIO.read(getClass().getResource("/recursos/capa_08.png")));
			movCliente.put("3th", ImageIO.read(getClass().getResource("/recursos/capa_09.png")));
			movCliente.put("4th", ImageIO.read(getClass().getResource("/recursos/capa_10.png")));
			...
			movCliente.put("pll", ImageIO.read(getClass().getResource("/recursos/capa_17.png")));
			movCliente.put("plr", ImageIO.read(getClass().getResource("/recursos/capa_15.png")));
			movCliente.put("prr", ImageIO.read(getClass().getResource("/recursos/capa_16.png")));
			movCliente.put("prl", ImageIO.read(getClass().getResource("/recursos/capa_18.png")));
			movCliente.put("ca1", ImageIO.read(getClass().getResource("/recursos/capa_14.png")));
			movCliente.put("ca2", ImageIO.read(getClass().getResource("/recursos/capa_11.png")));
			movCliente.put("ca3", ImageIO.read(getClass().getResource("/recursos/capa_12.png")));
			movCliente.put("ca4", ImageIO.read(getClass().getResource("/recursos/capa_13.png")));
